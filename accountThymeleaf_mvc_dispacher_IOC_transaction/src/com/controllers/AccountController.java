...
public class AccountController extends ViewBaseServlet {
    ...
    private String index(HttpServletRequest req) throws SQLException, NoSuchFieldException, InvocationTargetException, NoSuchMethodException, IllegalAccessException, InstantiationException {
...
//            super.processTemplate("indexWithSearch", req, resp);
    ...
    private String add(HttpServletRequest req) throws SQLException, NoSuchFieldException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
...
//        }
    ...
    private String del(HttpServletRequest req) throws SQLException {
...
//                resp.sendRedirect("account.do");
    ...
    private String edit(HttpServletRequest req) throws SQLException, NoSuchFieldException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
        String idStr = req.getParameter("id");
        if (Utile.strNotNull(idStr)) {
...
//                super.processTemplate("edit", req, resp);
    ...
    private String update(HttpServletRequest req) throws SQLException, NoSuchFieldException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
        String idStr = req.getParameter("id");
        String name = req.getParameter("name");
        String balanceStr = req.getParameter("balance");
        String birthdayStr = req.getParameter("birthday");
